...
let myCat = new Cat (`Ginger`, 5, `orange`)
...
let castSpell = new Wizard (`Ben`, 23, `fly`)
console.log(`${castSpell.name} has cast ${castSpell.favoriteSpell}`)
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
//Code Here
let phone1 = new Phone(`Iphone`, `12`, 1, `blue`, 800)
let phone2 = new Phone(`Iphone`, `3`, 1, `grey`, 300)
let phone3 = new Phone(`Iphone`, `X`, 1, `red`, 600)
/* 
...
//Code Here
let myFirstVehicle = new Vehicle(5, `grey`, 22000)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(1, `black`, 33000, `Kawasaki`, true)
/*
...
//Code Here
let myFirstBoat = new Boat(12, `white`, 5000, `Betty`, `Sail boat`, false)
/*
